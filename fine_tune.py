...
if __name__ == '__main__':
    config = {
        ...
        'teacher_path': '/root/terry/CoWIP/lightning_logs/CLIPVAE/RN50_1x1_NYCU/checkpoints/CLIPVAE-epoch=71-step=137448-total_loss=5.00.ckpt',
    }
